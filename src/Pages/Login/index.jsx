            ...
            <div className={styles.bloco}>
                ...
                <form className={styles.form}>
                    <div className={styles.blocos_input} id="bloco-nome">
                        <input className={styles.nome} id="name" type="text" placeholder="Nome ou e-mail do usuário" required  autocomplete="name"/>
                    ...
                    <p>Não possui uma conta? <Link to="/criarlogin" className={styles.cliqueAqui} href="login.html">Clique aqui</Link></p>
                </form>
            </div>
        </div>
        </>
